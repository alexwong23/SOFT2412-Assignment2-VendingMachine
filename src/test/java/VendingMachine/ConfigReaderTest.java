...
public class ConfigReaderTest {
    ...
    public void readRateConfigs() {
        ...
        assertTrue(expected.get("USD")==test.get("USD"));
        assertTrue(expected.get("AUD")==test.get("AUD"));
        assertTrue(expected.get("CNY")==test.get("CNY"));
        assertTrue(expected.get("JPY")==test.get("JPY"));
        assertTrue(expected.get("CAD")==test.get("CAD"));
    }
}